    ...
    def run(self):
        while self.__running:
            if keyboard.is_pressed('ctrl'):
                ...
                self.parent.send_keyboard_log('ctrl')

            elif keyboard.is_pressed('alt'):
                print("Press Alt Key")
                self.parent.send_keyboard_log('alt')

            elif keyboard.is_pressed('win'):
                print("Press Window Key")
                self.parent.send_keyboard_log('win')
